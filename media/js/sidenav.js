$(document).ready(function() {
    ...
    (function(){
		function initHeading(){
            ...
            $.each($('.post h2, .post h3'),function(index,item){
		...
		function genTmpl(){
            ...
            for(var i=0;i<h2.length;i++){
                tmpl += '<li style="list-style-type:circle;"><a href="#" data-id="'+h2[i].id+'">'+h2[i].name+'</a></li>';

                if(h3[i]){
                    for(var j=0;j<h3[i].length;j++){
                        tmpl += '<li class="h3" style="list-style-type:none;"><a href="#" data-id="'+h3[i][j].id+'">'+h3[i][j].name+'</a></li>';
                    }
                }
            }
            tmpl += '</ul>';
